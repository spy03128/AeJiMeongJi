...
def getPetPlace(petPlaceId):
    ...
    name = name[:len(name) - len(description)]
...
for p in petPlaceList:
    ...
    (id, name, description, address, point, tel, category, detail, home_page, opening_hours)
    values (%s, %s, %s, %s, POINT(%s, %s), %s, %s, json_object('1', %s, '2', %s, '3', %s, '4', %s), %s, %s)
    """
    val = (
    id, name, description, address, lat, lng, tel, category, detail[0], detail[1], detail[2], detail[3], homePage,
    openingTime)
